...
<template>
  <div class="post-list-container">
    <!-- 置顶帖子区域 -->
    <div class="pinned-post-list-container">
      <!-- 置顶帖子标题头部栏 -->
      <ContentTitle title="置顶帖子" />
      <div class="pinned-post-list-content">
        <Post v-for="(post, index) in pinnedPosts" :key="index" :post-data="post" />
      </div>
    </div>
    <!-- 普通帖子区域 -->
    <div class="post-list-container">
